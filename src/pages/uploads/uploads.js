...
<PlainNavbar/>
            ...
            <div className="w-full ">
                ...
                <div class="w-full mb-10 md:ml-20 ml-10 md:mt-10 mt-10 grid grid-cols-1 xl:grid-cols-[58%,40%] gap-2"  >

                <div className='mt-8 mb-10  w-[80%]  xl:w-[90%]  h-auto rounded-[20px] bg-sh-cream  '>
                    <div className='flex justify-between'>
                        ...
                        <button onClick={goToCreate} className='text-left flex items-end justify-between rounded-[10px] bg-sh-blue mx-8 lg:px-[12%] px-[4%]   py-2 lg:py-3 mt-6 text-base font-semibold hover:scale-105 transition-all duration-300 ease-in-out hover:opacity-90 text-white cursor-pointer '>ADD NEW</button>
                    </div>
          ...
          <div className='mx-8 pb-10'>
            ...
            />
                ...
                {/* <div className='mt-8 mb-10 ml-10 w-[80%]  h-auto rounded-[20px] bg-sh-cream  '>
                   ...
                   <div className='mt-8 mb-10 w-[70%] xl:w-[80%] h-[40rem]  lg:h-[41rem] rounded-[20px] bg-sh-cream  '>

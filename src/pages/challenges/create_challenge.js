    ...
    return (
        <div className="flex-col w-full overflow-x-hidden ">
            ...
            <div className="w-full ">
                ...
                <div className="  mt-10 mb-10  md:ml-20  w-[80%] rounded-[20px] h-[41rem] xl:h-[36rem] bg-sh-cream">
                    <div className="flex items-start justify-start pt-5 ml-10 font-bold text-xl"> Add New Challenge</div>

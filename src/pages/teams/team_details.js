...
function TeamDetails() {
  ...
  const {
    ...
    handlePageChange: handleTeamsDetailPageChange,
  } = UsePagination(1, 10);
  ...
  const coords = "(09102)";
  const message =
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque condimentum luctus mollis. Curabitur tempor gravida quam non rhoncus. Ut mattis mi et turpis cursus, ac interdum erat porta. Ut porta pretium condimentum. Integer a quam erat. Vivamus consectetur purus tortor";
    ...
    <div className="flex-col w-full overflow-x-hidden ">
      ...
      <div className="xl:ml-[5%] text-left grid md:grid-cols-3 lg:grid-cols-[20%,25%,25%,25%] xl:grid-cols-[15%,15%,15%,15%,15%,15%] ml-[8%] md:mt-12">
        <div>
          ...
          <div className="text-left text-xl mt-3  font-bold">
            {teamData.status}
          </div>
        </div>
        <div>
          <span className="text-left text-sm text-sh-gray lg:ml-[10%] xl:ml-0 font-bold">
            Points Scored
          </span>
          <div className="text-left text-xl lg:ml-[10%] xl:ml-0 mt-3 font-bold">
            {teamData.points_scored}
          </div>
        </div>
        <div>
        ...
        <div className="lg:mt-0 mt-8">
          <span className="text-left text-sm text-sh-gray lg:ml-[10%] font-bold">
            Route Started
          </span>
          <div className="text-left text-xl mt-3  lg:ml-[10%] font-bold">
            {teamData.route_started
              ? convertDateFormat(teamData.route_started)
              : "N/A"}
          </div>
        </div>
        <div className="xl:mt-0 mt-8">
          <span className="text-left text-sm text-sh-gray xl:ml-[10%] font-bold">
            Time Taken
          </span>
          <div className="text-left text-xl mt-3 xl:ml-[10%] font-bold">
            {teamData.time_taken ? teamData.time_taken : "N/A"}
          </div>
        </div>
        <div className="xl:mt-0 mt-8">
          <span className="text-left text-sm text-sh-gray ml-[10%] font-bold">
